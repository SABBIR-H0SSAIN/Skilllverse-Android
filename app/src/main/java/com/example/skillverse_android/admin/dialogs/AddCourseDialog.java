...
public class AddCourseDialog extends DialogFragment {
    private OnCourseAddedListener listener;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setView(view)
                ...
                .setPositiveButton("Create", (dialog, which) -> createCourse())
    ...
    private void createCourse() {
        ...
        AdminFirestoreRepository.createCourse(course, new AdminFirestoreRepository.DataCallback<String>() {
            @Override
            ...
            public void onFailure(String error) {
                if (!isAdded() || getContext() == null) return;
                Toast.makeText(getContext(), "Error creating course: " + error, Toast.LENGTH_LONG).show();
            }
        });
    }
}
